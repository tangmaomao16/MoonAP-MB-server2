...
Use this directory for system structure, runtime wiring, and cross-component technical summaries.

Current canonical topics:

- [Project Summary Handoff](C:/my_work/MoonBit_Competition/GitHub/MoonAP-MB-server2/docs/project-summary-codex-handoff.md)
...
The root-level files remain in place for compatibility right now. This directory defines the intended long-term category.
